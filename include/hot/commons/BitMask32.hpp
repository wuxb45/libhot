...
inline BitMask32
BitMask32::create(std::initializer_list<uint8_t> slotsToReserve) {
  BitMask32 slots;
...
inline uint32_t const &BitMask32::getMask() const { return mUsedSlots; }

inline void BitMask32::setMask(uint32_t newMask) { mUsedSlots = newMask; }
...
inline BitMask32Iterator BitMask32::begin() const { return {*this}; }
...
inline BitMask32Iterator::BitMask32Iterator(BitMask32 const &original)
    : mCopy{original}, mCurrent{original.getFirstUsedSlot()} {}

inline int BitMask32Iterator::operator*() const { return mCurrent; }
