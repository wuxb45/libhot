...
template <typename NodeType> class NodeAllocationInformations {
  static std::array<NodeAllocationInformation, MAXIMUM_NUMBER_NODE_ENTRIES>
      mAllocationInformations;

public:
  static inline NodeAllocationInformation const &
  getAllocationInformation(size_t numberEntries);
};

template <typename NodeTypename>
std::array<NodeAllocationInformation, MAXIMUM_NUMBER_NODE_ENTRIES>
    NodeAllocationInformations<NodeTypename>::mAllocationInformations{
...
template <typename NodeTypename>
inline NodeAllocationInformation const &
NodeAllocationInformations<NodeTypename>::getAllocationInformation(
