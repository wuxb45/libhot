...
template <typename PartialKeyType> struct PartialKeyConversionInformation {
  ...
  PartialKeyConversionInformation(PartialKeyType const additionalMask,
                                  PartialKeyType const conversionMask)
      : mAdditionalMask(additionalMask), mConversionMask(conversionMask) {}
};
