...
template <uint numberBits> struct SIMDHelper {
  using SIMDRegisterType =
      typename SIMDRegisterTypeMapper<numberBits>::SIMDRegisterType;

  /**
   * Create mask from the most significant bit of each 8-bit element of the
   * input register
   ...
   * @return for each equal packaged 8-bit integer the value 0xFF is set in the
   * output register
   */
  static inline SIMDRegisterType cmpeq_epi8(SIMDRegisterType a,
                                            SIMDRegisterType b);
   ...
   */
  static inline SIMDRegisterType binaryAnd(SIMDRegisterType a,
                                           SIMDRegisterType b);
   ...
   */
  static inline SIMDRegisterType binaryOr(SIMDRegisterType a,
                                          SIMDRegisterType b);
   ...
   */
  static inline SIMDRegisterType binaryAndNot(SIMDRegisterType a,
                                              SIMDRegisterType b);
   ...
   */
  static inline SIMDRegisterType
  toRegister(std::array<uint64_t, numberBits / 64u> const &array);
   ...
   */
  static inline void store(SIMDRegisterType data,
                           std::array<uint64_t, numberBits / 64u> &array);
...
template <> struct SIMDHelper<64u> {
  using SIMDRegisterType =
      typename SIMDRegisterTypeMapper<64>::SIMDRegisterType;

  static inline __attribute__((always_inline)) uint32_t
  moveMask8(SIMDRegisterType inputRegister) {
    return _mm_movemask_pi8(inputRegister);
  }

  static inline __attribute__((always_inline)) SIMDRegisterType
  cmpeq_epi8(SIMDRegisterType a, SIMDRegisterType b) {
    return _mm_cmpeq_pi8(a, b);
  }

  static inline __attribute__((always_inline)) SIMDRegisterType
  set1_epi8(uint8_t byte) {
  ...
  static inline __attribute__((always_inline)) SIMDRegisterType
  binaryAnd(SIMDRegisterType a, SIMDRegisterType b) {
    return _mm_and_si64(a, b);
  }

  static inline __attribute__((always_inline)) SIMDRegisterType
  binaryOr(SIMDRegisterType a, SIMDRegisterType b) {
    return _mm_or_si64(a, b);
  }

  static inline __attribute__((always_inline)) SIMDRegisterType
  binaryAndNot(SIMDRegisterType a, SIMDRegisterType b) {
    return _mm_andnot_si64(a, b);
  }

  static inline __attribute__((always_inline)) SIMDRegisterType
  shiftLeftOneByte(SIMDRegisterType a) {
    return _mm_slli_si64(a, 8);
  }

  static inline __attribute__((always_inline)) SIMDRegisterType
  toRegister(std::array<uint64_t, 1u> const &array) {
    return _mm_cvtsi64_m64(*array.data());
  }

  static inline __attribute__((always_inline)) SIMDRegisterType
  toRegister(void const *data) {
    return _mm_cvtsi64_m64(*reinterpret_cast<uint64_t const *>(data));
  }

  static inline __attribute__((always_inline)) void
  store(SIMDRegisterType data, std::array<uint64_t, 1u> &array) {
    array[0] = _mm_cvtm64_si64(data);
  }

  static inline __attribute__((always_inline)) void store(SIMDRegisterType data,
                                                          void *location) {
    *reinterpret_cast<uint64_t *>(location) = _mm_cvtm64_si64(data);
  };
};

template <> struct SIMDHelper<128u> {
  using SIMDRegisterType =
      typename SIMDRegisterTypeMapper<128>::SIMDRegisterType;
  ...
  static inline __attribute__((always_inline)) SIMDRegisterType
  convertWithZeroExtend(SIMDHelper<64u>::SIMDRegisterType sourceRegister) {
  ...
  static inline __attribute__((always_inline)) SIMDRegisterType
  toRegister(std::array<uint64_t, 2u> const &array) {
    return _mm_lddqu_si128(
        reinterpret_cast<SIMDRegisterType const *>(array.data()));
  }

  static inline __attribute__((always_inline)) SIMDRegisterType
  toRegister(void const *rawData) {
  ...
  static inline __attribute__((always_inline)) void
  store(SIMDRegisterType data, std::array<uint64_t, 2u> &array) {
...
template <> struct SIMDHelper<256u> {
  using SIMDRegisterType =
      typename SIMDRegisterTypeMapper<256>::SIMDRegisterType;
  ...
  static inline __attribute__((always_inline)) SIMDRegisterType
  convertWithZeroExtend(SIMDHelper<128u>::SIMDRegisterType sourceRegister) {
  ...
  static inline __attribute__((always_inline)) SIMDRegisterType
  set1(uint16_t unsignedShort) {
    return _mm256_set1_epi16(unsignedShort);
  }

  static inline __attribute__((always_inline)) SIMDRegisterType
  set1(uint32_t unsigneInt) {
  ...
  static inline __attribute__((always_inline)) SIMDRegisterType
  toRegister(std::array<uint64_t, 4u> const &array) {
  ...
  toRegister(void const *rawData) {
    return _mm256_loadu_si256(
        reinterpret_cast<SIMDRegisterType const *>(rawData));
  }
  ...
  static inline __attribute__((always_inline)) void
  store(SIMDRegisterType data, std::array<uint64_t, 4u> &array) {
    _mm256_storeu_si256(reinterpret_cast<SIMDRegisterType *>(array.data()),
                        data);
  }
