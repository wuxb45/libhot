...
public:
  ...
  HOTRowexIteratorStackEntry *
  init(HOTRowexChildPointer const *const &currentPointerLocation,
       HOTRowexChildPointer const *const &end) {
  ...
  HOTRowexIteratorStackEntry *
  init(HOTRowexChildPointer const *const &currentPointerLocation,
       HOTRowexChildPointer const &current,
       HOTRowexChildPointer const *const &end) {
    mCurrentPointerLocation = currentPointerLocation;
    mCurrent = current;
    mEnd = end;
  ...
  HOTRowexChildPointer const &getCurrent() const { return mCurrent; }

  HOTRowexChildPointer const *getCurrentPointerLocation() const {
    return mCurrentPointerLocation;
  }

  bool isLastElement() const { return (mCurrentPointerLocation + 1) >= mEnd; }
