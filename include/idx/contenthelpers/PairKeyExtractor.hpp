 ...
 *
 * @tparam PairLikeType a pair like type having at least 'first' and 'second'
 * field with the 'first' field pointing to the key part and the 'second' field
 * pointing to the value part
 */
template <typename PairLikeType> struct PairKeyExtractor {
